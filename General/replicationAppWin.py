...
while True:
    ...
    # Select inputs
    if event in ('dataBrowse', 'Ctrl-b-5'):
        dataFolder =  selectFolder("Select Folder")
        if dataFolder:
            updateListboxItems(
                window=window,
                key='data',
    ...
    # Remove inputs
    if event in ('removeDataFolders', 'Ctrl-r-5'):
        updateListboxItems(
            window=window,
            key='data'
        )    
    ...
    # Select inputs
    if event in ('dependenciesBrowse', 'Ctrl-b-6'):
    ...
    # Remove inputs
    if event in ('removeDependencies', 'Ctrl-r-6'):
        updateListboxItems(
            window=window,
            key='dependencies'
        )
    ...
    # Select inputs
    if event in ('toolsBrowse', 'Ctrl-b-7'):
    ...
    # Remove inputs
    if event in ('removeToolsFolders', 'Ctrl-r-7'):
        updateListboxItems(
            window=window,
            key='tools'
        )
